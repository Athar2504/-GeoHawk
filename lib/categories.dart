  ...
  Future<void> _fetchShoppers() async {
    try {
      final Uri url = Uri.parse(
          'https://volarfashion.in/app/all_location.php?timestamp=${DateTime.now().millisecondsSinceEpoch}');
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final selected = category == categories[index];
                    return GestureDetector(
                      onTap: () {
                        setState(() {
                          category = categories[index]; // ✅ Fixed this
                        });
                      },
                      child: Container(
              ...
              _shoppers.isEmpty
                ...
                child: Text("No shoppers nearby or still loading..."),
              ))
                  : ListView.builder(
                shrinkWrap: true,
                ...
                itemBuilder: (context, index) {
                  ...
                  if (category != 'ALL' &&
                      categoryIdToName[shopper['category']] != category) {
  ...
  Future<List<String>> _fetchShopperImages(String email) async {
    ...
    try {
      ...
      if (docSnapshot.exists) {
        ...
        if (data.containsKey('business_images') &&
            data['business_images'] is List) {
                  ...
                  children: [
                    ...
                    FutureBuilder<List<String>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.hasError || !snapshot.hasData || snapshot
                            .data!.isEmpty) {
                          return Container(
                            height: 300,
                            child: Image.asset(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    style: TextStyle(fontSize: 20,
                                        ...
                                        color: Colors.black),
                                    children: [
                                      TextSpan(text: shopper["username"] ??
                                          "Shop Name"),
                                      TextSpan(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          double hawkerLatitude = (shopper['latitude'] as num)
                              .toDouble();
                          double hawkerLongitude = (shopper['longitude'] as num)
                              .toDouble();
                          Navigator.push(
                            context,
                            MaterialPageRoute(
